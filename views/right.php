<div class="right_con">
  <form action="<?php echo site_url('search');?>" class="search_right">
    <input type="text" name="q" class="search_right_q" value="" />
  ...
  <div class="widget">
    ...
    <ul>
      <?php foreach ($post_hot['list'] as $line) {?>
        <li>
          <a href="<?php echo site_url($line['channeltype'].'/'.$line['id'].'/'.$line['slug']);?>" title="<?php echo $line['title'];?>">
            <?php echo $line['title'];?>
          </a>
          <?php echo $line['click'];?>℃</li>
        <?php } ?>
    </ul>
  </div>
  <div class="widget">
    ...
    <ul>
      <?php foreach ($comments_new['list'] as $line) {?>
        <li>
          <a href="<?php echo site_url($line['channeltype'].'/'.$line['pid'].'/'.$line['slug']);?>#comments_id_<?php echo $line['id'];?>" title="评论给《<?php echo $line['title'];?>》">
  ...
  <div class="widget">
    ...
    <ul>
      <?php foreach ($friendlink['list'] as $line) {?>
        <li>
          <a href="<?php echo $line['url']?>" title="<?php echo $line['dec'];?>" target="_blank">
            <?php echo $line['title'];?>
          </a>
        </li>
        <?php } ?>
